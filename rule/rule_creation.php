<?php
    ...
    $securityGroupRuleId = create_security_group_ingress_rule($securityGroupName, $ruleName, $protocol, $portRange, $sourceIp);
    if ($securityGroupRuleId === null) {
        ...
        $query = "INSERT INTO `security_group_rule` (`id_security_group`, `name`, `security_group_rule_id`, `source_port`, `port_range`, `source_ip`, `dest_ip`, `protocol`)
            VALUES ('$sgId', '$ruleName', '$securityGroupRuleId', '$sourcePort', '$portRange', '$sourceIp', '$destIp', '$protocol')";
